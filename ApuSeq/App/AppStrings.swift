...
enum AppStrings {
    ...
    static let renameCurrentSequence = String(localized: "Rename Current Sequence...")
    ...
    static let deleteCurrentSequence = String(localized: "Delete Current Sequence")
    ...
    static let editModeAutosaveWarningTitle = String(localized: "Changes in Edit mode are autosaved.")
    static let editModeAutosaveWarningMessage = String(localized: "Edits are saved to the file. Use File > Revert To to restore an earlier version.")
    ...
    static let currentSequenceMenu = String(localized: "Current Sequence")
